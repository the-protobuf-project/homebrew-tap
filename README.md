...
| `protoc-gen-cache` | Generate typed read-through cache decorators over protoc-gen-store stores | `brew install --cask the-protobuf-project/tap/protoc-gen-cache` |
